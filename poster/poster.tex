...
%\psbox[fillstyle=solid,linewidth=1pt,framearc=.5]{\makebox[0.98\textwidth]{
	\parbox[c]{1.4cm}{\includegraphics[width=4.8cm]{images/hiplogo.eps}}
	\hspace{0.6cm}
   \parbox[c]{0.8\linewidth}{
		\begin{center}

			\textbf{\Huge A Geant4 physics list for spallation and related nuclear physics applications 
based on INCL and ABLA models} \\[0.5em]
			\textbf{\LARGE \underline{Aatos Heikkinen}$^{\dagger, 1}$, Pekka Kaitaniemi$^{1, 2}$, Alain Boudard$^{2}$, Gunter Folger$^{3}$} \\[0.3em]
			{\Large $^{\dagger}$ {\tt aatos.heikkinen@cern.ch}} \\
                        ...
                        {\LARGE $^3$~European Organization for Nuclear Research (CERN), Switzerland}
                        \vskip2cm
		\end{center}
	}
	\parbox[c]{5.3cm}{\hspace{-1.0cm} \includegraphics[width=6.1cm]{images/g4logo.eps}}
%}}
...
\item Also, the {\sf Geant4} physics system can be easily extended.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vskip0.5cm
\includegraphics[scale=0.78]{images/inclAblaDoc.eps}
%\vskip-3.0cm
\vskip0.5cm
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{-5cm}
...
%\vspace{1cm}
which uses {\sf INCL/ABLA} models for proton,
...
\end{center}
{\large {\sf Fragment production of the {\sf INCL} and {\sf ABLA} \cite{abla, abla1, abla2} models. Black and red histograms are the
    results from the original {\sf FORTRAN} version and new {\sf C++} implementation, respectively. Data is from Ref \cite{gsifragments}}}
%\end{textbox}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{center}
{\large {\sf Double-differential for neutron production cross section
