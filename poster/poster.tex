...
based on INCL and ABLA models} \\[0.5em]
			\textbf{\LARGE \underline{Aatos Heikkinen}$^{1}$, Pekka Kaitaniemi$^{1, 2}$, Alain Boudard$^{2}$, Gunter Folger$^{3}$} \\[0.3em]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vskip0.5cm
\includegraphics[scale=0.70]{images/inclAblaDoc.eps}
\vskip0.5cm
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{textbox}
\vskip-0.2cm
...
\vspace{0.5cm}
It uses {\sf INCL/ABLA} models for proton,
