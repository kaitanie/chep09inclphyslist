...
%\psbox[fillstyle=solid,linewidth=1pt,framearc=.5]{\makebox[0.98\textwidth]{
   ...
   \parbox[c]{0.8\linewidth}{
		\begin{center}
			...
			\textbf{\Huge INCL/ABLA INTRA-NUCLEAR CASCADE MODELS \\ IN GEANT4~9.2} \\[0.5em]
...
In Geant4 9.2 \cite{g4} 
the INCL \cite{incl}  model is well established for targets heavier than Aluminium
...
Validity of the new Geant4 physics list 
...
%Finally, 
\vspace{1cm}
An ongoing work to improve of the physics models for the treatment of 
...
In {\tt Geant4}, \emph{physics models, cross sections, and processes are
...
%\begin{textbox}
\vspace{5cm}
\section*{{\Huge {\sf FRAGMENT PRODUCTION}}}
%Fragments produced in reaction: p(1 GeV) + Pb
\begin{center}
\includegraphics[scale=0.65]{images/fragments.eps}

%Isotope production:
\includegraphics[scale=0.55]{images/pPbIsotopes.eps}
\end{center}
%\end{textbox}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\includegraphics[scale=0.55]{images/aluminum.eps}
\end{center}
%\end{textbox}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{\color{udsect}
Recently a Carbon projectile support has been added to the {\sf INCL}
cascade. Carbon beams are of particular interest for medical applications of {\sf
Geant4}.
