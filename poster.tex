...
{\color{udsect}
We present the first implementation \cite{fp} of the hadronic cascade model INCL 4.2
\cite{incl} and evaporation model ABLA V3 \cite{abla} in Geant4 9.1 \cite{g4}.
\vskip0.5cm

INCL and ABLA models play an important role in nuclear physics
applications, especially in spallation reaction simulations.  The
inclusion of these models into Geant4 makes it possible to use them
...
ABLA is an evaporation and fission code developed at GSI, Darmstadt.
\vskip0.5cm
